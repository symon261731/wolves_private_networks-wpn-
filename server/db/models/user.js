...
module.exports = (sequelize, DataTypes) => {
  class User extends Model {
     ...
     */
    static associate({ServerVPN, File, Comment, UserComment, RatingServer, RatingUser, Order, OrderUser, Purchase, Card, Transaction, RatingComment}) {
      ...
      this.hasMany(RatingComment, { foreignKey: 'user_id' });
    }
  }
  User.init({
